...
def main(args):
    ...
    for epoch in range(args.max_epoch):
        ...
        if args.all_model:
            ...
            print("------torch.save(model, checkpoint_path) -----")
        else:
            torch.save(model.state_dict(), checkpoint_path)
            print("-------------torch.save(model.state_dict(), checkpoint_path)-----")
...
def parse_arguments(argv):
    ...
    # parser.add_argument('--pretrained_model', type=str, default='pretrained_model/mobileNetV2_0.25.pth')
    parser.add_argument('--pretrained_model', type=str, default='pretrained_model/mobileNetV2_0.25.pth')
